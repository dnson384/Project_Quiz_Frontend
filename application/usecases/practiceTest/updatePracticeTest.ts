...
export class UpdatePracticeTestUsecase {
  constructor(private readonly practiceTestRepository: IPracticeTestRepository) {}
  ...
  async execute(
    ...
    return await this.practiceTestRepository.updatePracticeTest(practiceTestId, accessToken, updatePracticeTest);
  }
}
