    ...
    <main>
      <nav className="flex justify-between items-center px-6 py-3">
        ...
        <div
          ...
          className={`w-2xl bg-[#F6F7FB] py-2 px-4 rounded-lg flex items-center gap-2 transition-all duration-200 ${
            inputRef ? "border border-indigo-500" : ""
          }`}
        ...
        <div className="flex gap-3">
          <button className="w-[120px] py-1 px-3 border-2 border-indigo-500 rounded-full cursor-pointer text-indigo-500 font-bold">
            Đăng ký
          </button>
          <button className="w-[120px] py-1 px-3 border-2 bg-indigo-500 border-indigo-500 rounded-full cursor-pointer text-white font-bold">
            Đăng nhập
          </button>
        </div>
      </nav>
