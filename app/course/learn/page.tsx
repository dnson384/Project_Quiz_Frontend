          ...
          <section className="w-5xl mx-auto px-7 py-5 border border-gray-300 rounded-lg">
            ...
            <div className="mb-16">
              ...
              <p className="text-xl font-semibold">
                {questions[currentQuestionIndex].question.term}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-3 select-none">
                {currentQuestion.map((option, index) => {
                  const correctAnwser =
                    questions[currentQuestionIndex].question.course_detail_id;
                  const hasAnswered = selectedOption !== null;
                  const isChosen = selectedOption === option.course_detail_id;
                  const isTargetAnswer =
                    option.course_detail_id === correctAnwser;

                  let containerStyle = "border-gray-200 hover:bg-gray-50";
