...
export default function CreateCourse() {
  ...
  const questionsArr = Array.from({ length: questionCount }, (_, i) => i);
  let missing = baseInfo?.name.length === 0 || questionData.length < 2;
        ...
        <section className="w-6xl mx-auto ">
          ...
          <form>
            <div className="flex flex-col gap-3">
              {questionsArr.map((index) => {
                // const termValue = questionData[index]?.questionBase.text || "";
                // const definitionValue = questionData[index]?.definition || "";
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="w-full">
                        <input
                          ...
                          // value={termValue}
                          placeholder="Câu hỏi"
                          onChange={(e) => handleQuestionBaseChange(e, index)}
                        />
                        <div className="flex items-center justify-between">
                          {isSubmitted && (
                            <span className="text-red-500 text-xs">
                              Vui lòng nhập câu hỏi này
                            </span>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="">
                      <div>
                        <select
                          ...
                          onChange={(e) => handleQuestionBaseChange(e, index)}
                        >
                          <option value="SINGLE_CHOICE">Đáp án duy nhât</option>
